...
- **Timetable Generation (`/menu/timetables/generate`):**
  ...
  - Displays "Program Health" cards with statistics on unassigned classes and empty blocks.

  - Cards include direct links to "Manage Offerings" and "Assign Instructors" for specific programs.
...
CREATE TABLE IF NOT EXISTS users (
    ...
    status VARCHAR(50) NOT NULL DEFAULT 'active' CHECK (status (status IN ('active', 'disabled')),
